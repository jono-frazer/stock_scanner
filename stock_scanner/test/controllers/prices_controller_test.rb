...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { close: @price.close, date: @price.date, high: @price.high, low: @price.low, open: @price.open, volume: @price.volume }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { close: @price.close, date: @price.date, high: @price.high, low: @price.low, open: @price.open, volume: @price.volume }
    assert_redirected_to price_path(assigns(:price))
  end
