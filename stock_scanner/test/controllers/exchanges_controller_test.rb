...
class ExchangesControllerTest < ActionController::TestCase
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post :create, exchange: { description: @exchange.description, name: @exchange.name, suffix: @exchange.suffix }
    end
  ...
  test "should update exchange" do
    patch :update, id: @exchange, exchange: { description: @exchange.description, name: @exchange.name, suffix: @exchange.suffix }
    assert_redirected_to exchange_path(assigns(:exchange))
  end
